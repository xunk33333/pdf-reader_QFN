...
def detect_qfn():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='match/yolov5/qfn_weight/best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='tmp_pic', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--project', default='tmp_txt', help='save results to project/name')
...
def scale_rec(x1, y1,  # upper-left corner
    ...
    s = scaling_factor  # scale by a factor of 2
    center_x = (x1 + x2) / 2
    center_y = (y1 + y2) / 2
